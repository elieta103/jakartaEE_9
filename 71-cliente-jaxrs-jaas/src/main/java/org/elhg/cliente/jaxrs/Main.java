package org.elhg.cliente.jaxrs;
...
import org.elhg.cliente.jaxrs.models.Curso;
import org.elhg.cliente.jaxrs.models.Instructor;
...
public class Main {
    public static void main(String[] args) {
        ...
        WebTarget rootUri = client.target("http://localhost:8080/71-webapp-jaxrs-jaas/api").path("/cursos");

        // ADMIN eliel 12345
        // USER july 12345
        rootUri.register(new BasicAuthentication("eliel", "12345"));
