...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            service = (ServiceEjbRemote) ctx.lookup("ejb:/73-appejb-remote-jaas/ServiceEjb!org.elhg.webapp.ejb.service.ServiceEjbRemote?stateful");
            service2 = (ServiceEjbRemote) ctx.lookup("ejb:/73-appejb-remote-jaas/ServiceEjb!org.elhg.webapp.ejb.service.ServiceEjbRemote?stateful");
